...
def main(argv):
    ...
    # nn.add(InputLayer(784,  learning = 0.25, regular = 0.001, momentum = 0.0125))
    # nn.add(HiddenLayer(512, learning = 0.25, regular = 0.001, momentum = 0, function = ReLU()))
    # nn.add(HiddenLayer(512, learning = 0.25, regular = 0.001, momentum = 0, function = ReLU()))


    # nn.add(InputLayer(784,  learning = 0.1, regular = 0.001, momentum = 0.0125))
    # nn.add(HiddenLayer(512, learning = 0.1, regular = 0.001, momentum = 0, function = ReLU()))
    # nn.add(HiddenLayer(512, learning = 0.1, regular = 0.001, momentum = 0, function = ReLU()))


    # nn.add(InputLayer(784,  learning = 0.25, regular = 0.1, momentum = 0.0125))
    # nn.add(HiddenLayer(512, learning = 0.25, regular = 0.1, momentum = 0, function = ReLU()))
    # nn.add(HiddenLayer(512, learning = 0.25, regular = 0.1, momentum = 0, function = ReLU()))
    ...
    # nn.add(InputLayer(784,  learning = 0.1, regular = 0.001, momentum = 0.01))
    # nn.add(HiddenLayer(512, learning = 0.1, regular = 0.001, momentum = 0, function = ReLU()))
    # nn.add(HiddenLayer(512, learning = 0.1, regular = 0.001, momentum = 0, function = ReLU()))



    # nn.add(HiddenLayer(512, learning = 0.1, regular = 0.01, momentum = 0.01))
    # nn.add(HiddenLayer(100, learning = 0.1, regular = 0.01, momentum = 0.01))
